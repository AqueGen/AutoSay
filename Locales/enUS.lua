...
L["Smart mode desc"] = "Detects key level from your listing, your own keystone, or the listing title. Uses the most reliable source available."
L["Placeholder hint"] = "Use {dungeon} for dungeon name and {key} for key level in custom messages."
L["Auto-disable on real events"] = "Auto-disable on real events"
L["Auto-disable simulation when you join a real group"] = "Automatically turn off simulation mode when you join a real group, raid, or dungeon"
