...
L["Bundle button hint"] = "|cFF00FF00Green|r = bundle fully enabled. Click to enable it everywhere; click again to disable. Any class can use any style - the marked ones just lean that way."
