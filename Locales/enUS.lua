...
L["Include key level desc"] = "Put the key level in the announcement, e.g. \"Ruby Life Pools +12\". The level is read from your own keystone and from the Group Finder listing - when neither can be trusted, only the dungeon name is announced, never a guessed level."
