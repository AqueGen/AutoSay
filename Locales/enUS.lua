...
L["Bundle button hint"] = "The name turns |cFF00FF00green|r once every phrase of the set is enabled, and stays yellow while only some are. Any class can use any style."
