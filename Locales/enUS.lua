...
L["Time-of-day greetings desc"] = "Band phrases live in each channel's message lists, tagged [morning] / [evening] / [night], and are only used while your local time is in that band. This switch turns all of them off at once."
