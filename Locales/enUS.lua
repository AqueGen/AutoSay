...
L["Bundle button hint"] = "|cFF00FF00Green|r = bundle fully enabled. Click to enable it everywhere; click again to disable. Any class can use any style; the rows below only say which ones lean that way."
L["Style bundle applied"] = "Style bundle applied"
L["Style bundle removed"] = "Style bundle removed"
L["Tag navigation note"] = "Greyed rows cannot go out as things stand: everything greys while the addon itself is off, a whole column greys when its channel is off on the General tab or has no trigger switched on above, and single phrases follow their tag - [self] / [newcomers] follow this channel's triggers, role and [morning/evening/night] follow the master switches on the Style tab."
