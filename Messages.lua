...
AutoSay.Greetings = {
    ...
    { key = "butler_dps3", text = "allow me to expedite the encounter", style = "butler", role = "DAMAGER", trigger = "self" },
    ...
    { key = "minimal_hinames", text = "good to meet {names}", style = "minimal", trigger = "self" },
