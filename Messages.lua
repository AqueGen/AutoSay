...
AutoSay.Greetings = {
    ...
    { key = "pirate_dps2", text = "I brought the powder", style = "pirate", role = "DAMAGER", trigger = "self", keepCase = true },
    ...
    { key = "zoomer_dps2", text = "im cooking today", style = "zoomer", role = "DAMAGER", trigger = "self" },
    { key = "butler_tank1", text = "I shall receive the blows on your behalf", style = "butler", role = "TANK", trigger = "self", keepCase = true },
