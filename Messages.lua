...
AutoSay.Greetings = {
    ...
    { key = "fun_tank3", text = "walls up, bring them here", style = "fun", role = "TANK", trigger = "self" },
    { key = "fun_heal3", text = "health bars are my hobby", style = "fun", role = "HEALER", trigger = "self" },
    { key = "fun_dps3", text = "here to press the fun buttons", style = "fun", role = "DAMAGER", trigger = "self" },
    { key = "fun_hinames", text = "hey {names}, good to see you", style = "fun", trigger = "self" },
    ...
    { key = "classic_heal3", text = "heals are up", role = "HEALER", trigger = "self" },
    { key = "classic_dps3", text = "damage on the way", role = "DAMAGER", trigger = "self" },
    ...
    { key = "dark_tank3", text = "nothing passes me", style = "dark", role = "TANK", trigger = "self" },
    { key = "dark_heal3", text = "I decide who stands", style = "dark", role = "HEALER", trigger = "self" },
    { key = "dark_dps3", text = "the count begins", style = "dark", role = "DAMAGER", trigger = "self" },
    ...
    { key = "dark_names3", text = "{names} steps into the gloom", style = "dark", trigger = "others" },
    ...
    { key = "light_tank3", text = "I will keep everyone safe", style = "light", role = "TANK", trigger = "self" },
    { key = "light_heal3", text = "nobody falls on my watch", style = "light", role = "HEALER", trigger = "self" },
    { key = "light_dps3", text = "happy to help with the damage", style = "light", role = "DAMAGER", trigger = "self" },
    ...
    { key = "pirate_tank3", text = "I be the hull, hit me", style = "pirate", role = "TANK", trigger = "self" },
    { key = "pirate_heal3", text = "patching the crew, as ever", style = "pirate", role = "HEALER", trigger = "self" },
    { key = "pirate_dps3", text = "cannons ready", style = "pirate", role = "DAMAGER", trigger = "self" },
    { key = "pirate_names1", text = "ahoy {names}", style = "pirate", trigger = "self" },
    { key = "pirate_names2", text = "{names} joins the crew", style = "pirate", trigger = "others" },
    ...
    { key = "faction_tank3", text = "I hold the line for us", style = "faction", role = "TANK", trigger = "self" },
    { key = "faction_heal3", text = "none of ours falls today", style = "faction", role = "HEALER", trigger = "self" },
    { key = "faction_dps3", text = "my blade serves", style = "faction", role = "DAMAGER", trigger = "self" },
    { key = "faction_names1", text = "well met, {names}", style = "faction", trigger = "self" },
    ...
    { key = "zoomer_tank3", text = "tank here, send them my way", style = "zoomer", role = "TANK", trigger = "self" },
    { key = "zoomer_heal3", text = "healer here, stay alive pls", style = "zoomer", role = "HEALER", trigger = "self" },
    ...
    { key = "zoomer_names3", text = "welcome {names}, we ball", style = "zoomer", trigger = "others" },
    ...
    { key = "butler_tank3", text = "I shall stand in front, naturally", style = "butler", role = "TANK", trigger = "self" },
    { key = "butler_heal3", text = "your wellbeing is my duty", style = "butler", role = "HEALER", trigger = "self" },
    { key = "butler_dps3", text = "the damage shall be attended to", style = "butler", role = "DAMAGER", trigger = "self" },
    { key = "butler_names1", text = "good day, {names}", style = "butler", trigger = "self" },
    { key = "butler_names2", text = "{names} has arrived, very good", style = "butler", trigger = "others" },
    ...
    { key = "minimal_tank3", text = "tanking", style = "minimal", role = "TANK", trigger = "self" },
    { key = "minimal_heal3", text = "healing", style = "minimal", role = "HEALER", trigger = "self" },
    { key = "minimal_dps3", text = "damage", style = "minimal", role = "DAMAGER", trigger = "self" },
    { key = "minimal_hinames", text = "hi {names}", style = "minimal", trigger = "self" },
    { key = "minimal_names2", text = "{names} o/", style = "minimal", trigger = "others" },
    ...
    { key = "robot_tank3", text = "damage absorption unit online", style = "robot", role = "TANK", trigger = "self" },
    { key = "robot_heal3", text = "repair subroutine standing by", style = "robot", role = "HEALER", trigger = "self" },
    { key = "robot_dps3", text = "output routine armed", style = "robot", role = "DAMAGER", trigger = "self" },
    { key = "robot_names1", text = "units acknowledged: {names}", style = "robot", trigger = "self" },
    { key = "robot_names2", text = "new unit registered: {names}", style = "robot", trigger = "others" },
    ...
    { key = "deadpan_tank3", text = "tank. as usual.", style = "deadpan", role = "TANK", trigger = "self" },
    { key = "deadpan_heal3", text = "healing. probably.", style = "deadpan", role = "HEALER", trigger = "self" },
    { key = "deadpan_dps3", text = "damage. that is the job.", style = "deadpan", role = "DAMAGER", trigger = "self" },
    { key = "deadpan_names1", text = "hello {names}.", style = "deadpan", trigger = "self" },
    { key = "deadpan_names2", text = "{names}. hello.", style = "deadpan", trigger = "others" },
    { key = "deadpan_names3", text = "so that is {names} then", style = "deadpan", trigger = "others" },
    ...
    { key = "nature_tank3", text = "I am the bark that holds", style = "naturewarden", role = "TANK", trigger = "self" },
    { key = "nature_heal3", text = "the grove mends what breaks", style = "naturewarden", role = "HEALER", trigger = "self" },
    { key = "nature_dps3", text = "the storm answers me", style = "naturewarden", role = "DAMAGER", trigger = "self" },
    { key = "nature_names1", text = "well met, {names}", style = "naturewarden", trigger = "self" },
    { key = "nature_names2", text = "the grove greets {names}", style = "naturewarden", trigger = "others" },
    ...
    { key = "fantasy_heal3", text = "the Light is with us today", style = "fantasy", role = "HEALER", trigger = "self" },
    { key = "fantasy_dps3", text = "my steel is yours", style = "fantasy", role = "DAMAGER", trigger = "self" },
    { key = "fantasy_greetnames", text = "well met, {names}", style = "fantasy", trigger = "self" },
